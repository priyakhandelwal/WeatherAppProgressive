...
(function() {
  ...
  app.saveNewCity = function(key, label) {
  ...
  //Get all the cities form local storage: If none available display default
  if (typeof (Storage) !== undefined && sessionStorage.length > 0) {
    for (var key in sessionStorage) {
      app.getForecast(key, sessionStorage[key]);
    }
  } else {
